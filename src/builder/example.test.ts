...
const builderMap: Record<string, any> = {
  ...
  alwaysCritsAttack: examples.alwaysCritsAttack,
  alwaysHitsAlwaysCrits: examples.alwaysHitsAlwaysCrits,
...
const expectedExpressions: Record<string, string> = {
  ...
  alwaysCritsAttack: examples.alwaysCritsAttackExprExpected,
  alwaysHitsAlwaysCrits: examples.alwaysHitsAlwaysCritsExprExpected,
